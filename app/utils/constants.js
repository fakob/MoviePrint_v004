...
export const DEFAULT_TIMELINEVIEW_MINUTES_PER_ROW = 5.0;
export const DEFAULT_TIMELINEVIEW_MIN_DISPLAY_SCENE_LENGTH_IN_FRAMES = 100;
export const DEFAULT_TIMELINEVIEW_PIXEL_PER_FRAME_RATIO = 0.25;
