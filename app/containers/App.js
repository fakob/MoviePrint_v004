                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        backgroundImage: (this.props.file && this.props.settings.defaultShowPaperPreview) ? `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='${(this.props.settings.defaultPaperAspectRatioInv < this.state.scaleValueObject.newMoviePrintAspectRatioInv) ? (this.state.scaleValueObject.newMoviePrintHeight / this.props.settings.defaultPaperAspectRatioInv) : this.state.scaleValueObject.newMoviePrintWidth}' height='${(this.props.settings.defaultPaperAspectRatioInv < this.state.scaleValueObject.newMoviePrintAspectRatioInv) ? this.state.scaleValueObject.newMoviePrintHeight : (this.state.scaleValueObject.newMoviePrintWidth * this.props.settings.defaultPaperAspectRatioInv)}' style='stroke-width: 0px; background-color: rgba(255,255,255,1);'></svg>")` : undefined,
                        ...
                        // backgroundSize: (this.props.file && this.props.settings.defaultShowPaperPreview) ? `${SHOW_PAPER_ADJUSTMENT_SCALE * 100}% ${SHOW_PAPER_ADJUSTMENT_SCALE * 100}%` : undefined
                      }}
                    >
