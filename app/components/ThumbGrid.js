  ...
  thumbGridComponent = (
    thumbArray.map(thumb => (
      <SortableThumb
        ...
        onBack={showSettings ? null : (keys) => onBackClick(file, thumb.thumbId, thumb.frameNumber, keys)}
        onForward={showSettings ? null : (keys) => onForwardClick(file, thumb.thumbId, thumb.frameNumber, keys)}
